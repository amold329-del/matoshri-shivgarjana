          ...
          <div className="grid md:grid-cols-2">
            ...
            <div className="flex flex-col justify-center gap-4 p-8 sm:p-10">
              ...
              <p className="text-[1.02rem] leading-relaxed text-ink-soft">
                या आषाढी एकादशीच्या पावन निमित्ताने आमच्या मंडळातर्फे भाविकांना{" "}
                <b className="text-ink">केळीचे वितरण</b> केले जाणार आहे. सर्व
                भाविकांना सहभागी होण्याचे प्रेमळ आमंत्रण.
              </p>
              ...
              <div className="mt-1 flex items-center gap-2 text-sm font-semibold text-ink-soft">
                ...
                लहान सेवा, मोठा आनंद — सेवा हीच आमची ओळख.
              </div>
            </div>
          </div>
        </Reveal>
